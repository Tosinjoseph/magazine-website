...
const Travel = () => {
  return (
    <div className='overflow-hidden w-full gap-40  flex flex-col md:flex-row  justify-center mx-auto '>
     <div className='w-150 pl-6 md:pl-20 lg:pl-32'>
     <img src="./impulse-1.avif" alt=""  className='w-100 h-90 my-8 py-10'/>
     </div>
     <div className='justify-start bg-blue-50 w-full px-18  md:w-1/2 py-15'>
        <div className='bg-amber-800  w-30 h-2 mb-4'></div>
        <h2 className='text-4xl font-bold mb-4 text-gray-500'>This is my third and Latest Post</h2>
